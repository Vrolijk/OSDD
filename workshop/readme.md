...
Throughout the workshop, we will be working with 2 Ubuntu 22.04 computers to learn how to update the operating system configuration, change IP settings, and manipulate the ARP table. Additionally, we will test the connection from laptop PING to PONG and install software to start three different data streams through the data diode.
